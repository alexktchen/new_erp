...
## 12. Alex 回應（2026-04-29）

### 🔴 最高優先

| Q | 香奈問 | Alex 回 |
|---|---|---|
| 1 | AA 5/23 上線可行嗎？full-time 3 週？ | **一個月**（折衷 AA'）：工程 4 週、不衝 5/23、不退 7/1，上線約 **5/30** |
| 2 | PR #101 本週 merge？ | **好** — 本週 merge、後直接在 main 衝 RPC |
| 3 | Schema delta migration `2f6f1f7` review 過了？ | **對** — 已 review、無修改建議 |
